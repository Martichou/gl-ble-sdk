...
/**
 *  @brief  Update the firmware over the serial port.
 *
 *  @param file_path : Path of the new firmware file. Notice that this interface identifies only. GBL files
 *
 *  @retval  GL-RETURN-CODE
 */

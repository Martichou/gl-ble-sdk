...
extern struct sl_bt_packet *sl_bt_cmd_msg;
extern struct sl_bt_packet *sl_bt_rsp_msg;
                                        ...
                                        uint8_t maxevents)
{
    ...
    if (ENDIAN)
    {
        reverse_endian((uint8_t *)&interval_min, 4);
        reverse_endian((uint8_t *)&interval_max, 4);
        reverse_endian((uint8_t *)&duration, 2);
    }
